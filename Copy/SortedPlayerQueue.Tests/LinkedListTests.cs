...
namespace SortedPlayerQueue.Tests
{
    ...
    {
        SortedLinkedList<float> linkedList;// = LoadLinkedList((OrderingMode)(new Random().Next(0, 2)));
        ...
        {
            SortedLinkedList<float> linkedList = new SortedLinkedList<float>();
        ...
        public void Remove_ShouldWork(object obj)
        {
            ...
            linkedList.Remove(numbers[new Random().Next(0, numbers.Count)]);
        }
        ...
        public static SortedLinkedList<float> LoadLinkedList(OrderingMode order)
        {
            SortedLinkedList<float> linkedList = new SortedLinkedList<float>(order);
            int rnd = new Random().Next(0, byte.MaxValue * 8);
