...
namespace DataStructuresAndAlgorithms.Tests.Trees.Heaps
{
    public class MaxHeapTests
    {
        ...
        public void Add_TimerTest()
        {
            ...
            Directory.CreateDirectory("MaxHeap");
            string path = @"MaxHeap\BinaryMaxHeapAddTest.txt";
            File.Delete(path);
        ...
        public void Search_TimerTest()
        {
            BinaryMaxHeap<HeapData> maxHeap = new BinaryMaxHeap<HeapData>();
            Directory.CreateDirectory("MaxHeap");
            string path = @"MaxHeap\BinaryMaxHeapSearchTest.txt";
            File.Delete(path);
        ...
        public void Remove_TimerTest()
        {
            BinaryMaxHeap<HeapData> maxHeap = new BinaryMaxHeap<HeapData>();
            Directory.CreateDirectory("MaxHeap");
            string path = @"MaxHeap\BinaryMaxHeapRemoveTest.txt";
            File.Delete(path);
