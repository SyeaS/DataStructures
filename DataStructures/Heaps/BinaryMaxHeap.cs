...
namespace DataStructures.Heaps
{
        ...
        where T : class, IComparable<T>
    {
        ...
        public BinaryMaxHeap(int initialSize) : base(initialSize)
        {

        }

        public BinaryMaxHeap(IEnumerable<T> content) : base(content)
        {

        }

        public BinaryMaxHeap(IEnumerable<T> content, int initialSize) : base(content, initialSize)
        {
        ...
        private int GetGreater(int index)
        {
            ...
            {
                throw new NoGreaterElementException();
            }
