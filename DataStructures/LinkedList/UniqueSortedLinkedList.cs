...
{
    public sealed class UniqueSortedLinkedList<T> : DoublyLinkedList<T>
        where T : IComparable<T>
    {
        ...
        {
            return new UniqueSortedLinkedList<T>(orderingMode);
        }
        ...
        public static UniqueSortedLinkedList<T> operator +(UniqueSortedLinkedList<T> left, UniqueSortedLinkedList<T> right)
        {
        ...
        {
            return other as UniqueSortedLinkedList<T> == this;
        }

        public override bool Equals(object obj)
        {
            return obj as UniqueSortedLinkedList<T> == this;
        }
